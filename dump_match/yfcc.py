...
if __name__ == "__main__":
    ...
    vis_th=50
    pair_num=1000
    Dataset(../raw_data/yfcc100m/, ../data_dump/, yfcc-sift-2000-test.hdf5, 
        ['buckingham_palace','notre_dame_front_facade','reichstag', 'sacre_coeur'], 'test', sift-2000, 
        50, 1000, ../raw_data/pairs/)
    '''
    #生成测试集
